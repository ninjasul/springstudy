...
@Slf4j
public class _08_ValueTypeCollection {
    public static void main(String[] args) {
        JpaUtil.doTest(_08_ValueTypeCollection::doTest);
    }
    ...
    private static void doTest(EntityManager em) {
        ...
        member.getAddressHistories().add(new Address("oldCity1", "oldStreet1", "99999"));
        member.getAddressHistories().add(new Address("oldCity2", "oldStreet2", "99998"));
        ...
        foundMember.getAddressHistories().remove(new Address("oldCity1", "oldStreet1", "99999"));
        foundMember.getAddressHistories().add(new Address("newCity", "oldStreet1", "99999"));
    }
}